...
class _AddRecipeScreenState extends State<AddRecipeScreen> {
  ...
  void _handlePost() async {
    ...
    bool success = await RecipeService.createRecipe(
      ...
      content: contentJson,
      categoryId: 1, // Harusnya sesuai _selectedCategory, tapi backend butuh int. Asumsi Nasi = 1
      difficulty: "Easy", // Default
      cookingTime: _prepTimeController.text.isNotEmpty ? _prepTimeController.text : "30 min",
    ...
    if (success) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Resep berhasil diposting!")));
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const MainScreen()));
    } else {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text("Gagal memposting resep.")));
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("New Recipe", style: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.bold)),
        centerTitle: true,
        actions: [
          TextButton(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: const Color(0xFFE2E8F0), // Warna solid abu-abu kebiruan
                  image: _coverImage != null
                      ? DecorationImage(
                          image: kIsWeb ? NetworkImage(_coverImage!.path) : FileImage(File(_coverImage!.path)) as ImageProvider,
                          fit: BoxFit.cover,
                        )
                      : null,
                ),
                child: _coverImage == null
                    ? const Column(
                        ...
                        children: [
                          Icon(Icons.camera_alt, color: Color(0xFF4A4A4A), size: 40),
                          SizedBox(height: 8),
                          Text("Add a cover photo", style: TextStyle(color: Color(0xFF4A4A4A))),
                        ],
                      )
                    : null,
              ),
            ...
            _buildTextField("e.g. Saffron Infused Creamy Risotto", _titleController),
            const SizedBox(height: 24),

            // Short Description
            _buildSectionTitle("SHORT DESCRIPTION"),
            const SizedBox(height: 8),
            _buildTextField("Share the story behind this dish...", _descController, maxLines: 4),
            const SizedBox(height: 24),
              ...
              children: _categories.map((cat) {
                ...
                return ChoiceChip(
                  ...
                  shape: RoundedRectangleBorder(
                    ...
                    side: BorderSide(color: isSelected ? const Color(0xFF1E293B) : Colors.grey.shade300),
                  ),
                );
              }).toList(),
            ),
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: const Text("+ Add Item", style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
                ),
              ],
            ),
              ...
              return Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      flex: 2,
                      child: _buildTextField("Ingredient name...", ing["name"]!),
                    ),
                    if (_ingredients.length > 1)
                      IconButton(
            ...
            Row(
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: const Row(
                    children: [
                      Icon(Icons.add_circle, size: 16, color: Color(0xFF1E293B)),
                      SizedBox(width: 4),
                      Text("Add Step", style: TextStyle(fontWeight: FontWeight.bold, color: Color(0xFF1E293B))),
                    ],
                  ),
                ),
              ],
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _buildTextField("Describe the step...", controller, maxLines: 3),
            ...
            Row(
              children: [
                Expanded(
                  child: _buildInfoBox("PREP TIME", Icons.access_time, "15 min", _prepTimeController),
                ),
                const SizedBox(width: 16),
                Expanded(
                  child: _buildInfoBox("SERVINGS", Icons.people, "2 people", _servingsController),
                ),
              ],
            ),
  ...
  Widget _buildInfoBox(String title, IconData icon, String hint, TextEditingController controller) {
    return Container(
            ...
            children: [
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: hint,
                    hintStyle: const TextStyle(color: Colors.black87, fontWeight: FontWeight.bold, fontSize: 14),
                    isDense: true,
